...
p <- clean_slate() |>
  add_title(c(
    "Figure xxx",
    "Micro-RNA / Baseline - Soft threshold determination"
  )) |>
...
p <- clean_slate() |>
  add_title(c(
    "Figure xxx",
    "Messenger-RNA / Baseline - Soft threshold determination"
  )) |>
  add_figure(p, width = inches(6), height = inches(3))
show_slate(p)
```
...
p <- clean_slate() |>
  add_title(c(
    "Figure xxx",
    "Micro-RNA / Change from Baseline - Soft threshold determination"
  )) |>
  add_figure(p, width = inches(6), height = inches(3))
show_slate(p)
```
...
p <- clean_slate() |>
  add_title(c(
    "Figure xxx",
    "Messenger-RNA / Change from Baseline - Soft threshold determination"
  )) |>
  add_figure(p, width = inches(6), height = inches(3))
show_slate(p)
```
